...
public class ArrayListsTest {
    ...
    public void addShitTest5() {
        ...
        //When
        ArrayList<Integer> actual = arrayLists.addShit(original, null);
        //Then
        Assert.assertEquals(original, actual);
    }

    @Test
    public void addShitTest6() {
        //Given
        ArrayList<Integer> original = new ArrayList<Integer>();
        original.add(1);

        //When
        ArrayList<Integer> actual = arrayLists.addShit(null, original);
        //Then
        Assert.assertEquals(original, actual);
    }
    ...
    public void addShitTogetherTest4(){
        ...
        original.add(1);
        // When
        Integer actual = arrayLists.addShitTogether(original, null);
        Integer expected = 1;
        // Then
        Assert.assertEquals(expected, actual);
    }
    ...
    public void addShitTogetherTest5(){
        ...
        original.add(1);
        // When
        Integer actual = arrayLists.addShitTogether(null, original);
        Integer expected = 1;
        // Then
        Assert.assertEquals(expected, actual);
    }
